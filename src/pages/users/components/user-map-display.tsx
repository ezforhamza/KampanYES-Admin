...
interface UserMapDisplayProps {
	...
	longitude: number;
	/**
	 * User name for the marker
	 */
	userName: string;
	/**
	 * User address for display
	 */
	address: string;
	/**
...
export function UserMapDisplay({
	latitude,
	longitude,
	userName,
	address,
	...
	useEffect(() => {
		...
		if (mapRef.current) {
            ...
            <div style="max-width: 200px;">
              <h3 style="margin: 0 0 8px 0; font-weight: 600; color: #1f2937;">${userName}</h3>
	...
	}, [latitude, longitude, userName, address, API_KEY, mode, darkMapStyles]);
